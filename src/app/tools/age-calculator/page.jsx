          ...
          <div className="mt-4 space-y-2">
              ...
              <div className="collapse-content">
                {totalDays !== null && (
                  <>
                    <p className="text-sm text-gray-500">
                      Total weeks lived:{" "}
                      {Math.floor(totalDays / 7).toLocaleString()} weeks.
                    </p>
                    <p className="text-sm text-gray-500">
                      Total minutes lived:{" "}
                ...
                {ageResult && (
                  <p className="text-sm text-gray-500">
                    Age in dog years: {(ageResult.years * 7).toLocaleString()}{" "}
                    years.
                  </p>
                )}
                <p className="text-sm text-gray-500">{futurePrediction()}</p>
              </div>
            </div>
            <div
              tabIndex={1}
            ...
            >
              ...
              <div className="collapse-content">
                ...
                {futureAge && (
                  <p className="text-sm text-gray-500">
                    On {futureDate}, you will be {futureAge.years} years,{" "}
                    {futureAge.months} months, and {futureAge.days} days old.
                  </p>
                )}
              </div>
            </div>
